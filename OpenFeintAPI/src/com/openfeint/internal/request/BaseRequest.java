...
public abstract class BaseRequest {
	...
	protected HttpUriRequest generateRequest() {
		...
		addParams(retval);
		OpenFeintInternal.log("ForTest", "generateRequest::" + meth );
		OpenFeintInternal.log("ForTest", "generateRequest::" + retval.getURI().toString() );
				        ...
				        if (entity != null) {
				        	final Header contentEncoding = entity.getContentEncoding();
 				        	...
 				        	if (entity.getContentLength() >= 0 && entity.getContentLength() != mResponseBody.length) {
				        		...
				        		OpenFeintInternal.log("ForTest", "handleResponse::Content-Length mismatch with content - " + mRequest.getURI().toASCIIString());
				        		mResponseCode = 0;
				        	}
				        }
						response_ = response;
