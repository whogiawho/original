...
public class TubeTutor5Activity1 extends TubeTutorBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		View view = AdGlobals.getInstance().inflateContentView(this, R.layout.object4, AdGlobals.getInstance().getAdInterface());
		setContentView(view);
	...
	public void onClick(View v) {
		...
		switch(id){
		case R.id.next:
			nextSection("oms.cj.tube.tutor.basic.step5.TubeTutor5Activity2");
			break;
		default:
			super.onClick(v);
		}
