...
public class TubeTutor3Activity1 extends TubeTutorBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		View view = AdGlobals.getInstance().inflateContentView(this, R.layout.object2, AdGlobals.getInstance().getAdInterface());
		setContentView(view);
	...
	public void onClick(View v) {
		...
		switch(id){
		case R.id.next:
			nextSection("oms.cj.tube.tutor.basic.step3.TubeTutor3Activity2");
			break;
		default:
			super.onClick(v);
		}
