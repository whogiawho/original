...
public class TubeTutor9Activity1 extends TubeTutorBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		View view = AdGlobals.getInstance().inflateContentView(this, R.layout.object8, AdGlobals.getInstance().getAdInterface());
		setContentView(view);
	...
	public void onClick(View v) {
		...
		switch(id){
		case R.id.next:
			nextSection("oms.cj.tube.tutor.basic.step9.TubeTutor9Activity2");
			break;
		default:
			super.onClick(v);
		}
