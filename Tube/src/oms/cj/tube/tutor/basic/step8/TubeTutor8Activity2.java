...
public class TubeTutor8Activity2 extends TubeTutorBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		View view = AdGlobals.getInstance().inflateContentView(this, R.layout.solutionoverview7, AdGlobals.getInstance().getAdInterface());
		setContentView(view);
	...
	public void onClick(View v) {
		...
		switch(id){
		case R.id.next:
			nextSection("oms.cj.tube.tutor.basic.step8.TubeTutor8Activity3");
			break;
		default:
			super.onClick(v);
		}
