...
public final class Quaternion implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4859813873197629451L;
	
	public static Quaternion c0 = new Quaternion(new Vector3f(0,1,0), 0);
	public static Quaternion c1 = new Quaternion(-0.288f, 0.31f, 0.07f, 0.902f);
	public static Quaternion c2 = new Quaternion(-0.173f, 0.381f, 0.072f, 0.905f);
	public static Quaternion c3 = new Quaternion(new Vector3f(0,1,0), Math.PI/4);
	public static Quaternion c4 = new Quaternion(new Vector3f(1,0,0), -Math.PI/4);
	public static Quaternion c5 = c3.clone().mulThis(c4);
	public static Quaternion c6 = new Quaternion(new Vector3f(0,1,0), Math.PI/2);
	public static Quaternion c7 = new Quaternion(new Vector3f(0,1,0), Math.PI);
	public static Quaternion c8 = new Quaternion(new Vector3f(0,1,0), Math.PI/2*3);
	public static Quaternion c9 = new Quaternion(new Vector3f(1,0,0), -Math.PI/2);
	public static Quaternion c10 = new Quaternion(new Vector3f(1,0,0), Math.PI/2);
	private double x;
	private double y;
	private double z;
	private double w;
	 ...
	 * @return this
	 */
	public Quaternion set(Vector3f axis, double angle) {
		//matrixs = null;
