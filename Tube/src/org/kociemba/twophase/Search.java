...
import oms.cj.tube.solver.AdvancedDataLoader;
...
public class Search {
	...
	public static void saveToFile(ObjectOutputStream objectOut) throws FileNotFoundException, IOException{
		objectOut.writeObject(CoordCube.twistMove);
		objectOut.writeObject(CoordCube.flipMove);
		objectOut.writeObject(CoordCube.FRtoBR_Move);
		objectOut.writeObject(CoordCube.URFtoDLF_Move);
		objectOut.writeObject(CoordCube.URtoDF_Move);
		objectOut.writeObject(CoordCube.URtoUL_Move);
		objectOut.writeObject(CoordCube.UBtoDF_Move);
		objectOut.writeObject(CoordCube.MergeURtoULandUBtoDF);
		objectOut.writeObject(CoordCube.Slice_URFtoDLF_Parity_Prun);
		objectOut.writeObject(CoordCube.Slice_URtoDF_Parity_Prun);
		objectOut.writeObject(CoordCube.Slice_Twist_Prun);
		objectOut.writeObject(CoordCube.Slice_Flip_Prun);
	}
	private static void sendMessage(Handler handler, int type, int progress){
		Message msg = new Message();
		msg.what = type;
		msg.arg1 = progress;
		handler.sendMessage(msg);
	}
	public static void restoreFromFile(ObjectInputStream objectIn, Handler handler) throws OptionalDataException, ClassNotFoundException, IOException{		
		CoordCube.twistMove = (short[][]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 10);
		CoordCube.flipMove = (short[][]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 15);
		CoordCube.FRtoBR_Move = (short[][]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 30);
		CoordCube.URFtoDLF_Move = (short[][]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 50);
		CoordCube.URtoDF_Move = (short[][]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 70);
		CoordCube.URtoUL_Move = (short[][]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 75);
		CoordCube.UBtoDF_Move = (short[][]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 80);
		CoordCube.MergeURtoULandUBtoDF = (short[][]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 85);
		CoordCube.Slice_URFtoDLF_Parity_Prun = (byte[]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 90);
		CoordCube.Slice_URtoDF_Parity_Prun = (byte[]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 93);
		CoordCube.Slice_Twist_Prun = (byte[]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 97);
		CoordCube.Slice_Flip_Prun = (byte[]) objectIn.readObject();
		sendMessage(handler, AdvancedDataLoader.LOADING, 100);
